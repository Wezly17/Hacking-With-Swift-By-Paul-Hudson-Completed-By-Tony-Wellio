...
protocol Building{
    ...
    func salesSummary(rooms: Int, cost: Int, agent: String)
}
...
house.salesSummary(rooms: 5, cost: 50_000, agent: "John Marshton")
...
office.salesSummary(rooms: 200, cost: 500_000, agent: "Sarah Melic")
